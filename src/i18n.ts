...
const zhHans: Dict = {
  ...
  "archive.filterNote":
    "越剧与弹词文字层均为精选；弹词也可在导航「弹词」页上传图片做 OCR 后导入档案；广播为下一步扩展。",
  "archive.tanciTitle": "弹词 · 上传识别",
  "archive.tanciMeta": "站内 OCR · 导出后可进档案",
...
const zhHant: Dict = {
  ...
  "archive.filterNote":
    "越劇與彈詞文字層均為精選；彈詞也可在導航「彈詞」頁上傳圖片做 OCR 後導入檔案；廣播為下一步擴展。",
  "archive.tanciTitle": "彈詞 · 上傳識別",
  "archive.tanciMeta": "站內 OCR · 匯出後可進檔案",
...
const en: Dict = {
  ...
  "archive.filterNote":
    "Yue opera and a tanci text-layer starter are live; OCR more pages in the Tanci panel, then import. Radio is next.",
  "archive.tanciTitle": "Tanci · upload OCR",
  "archive.tanciMeta": "In-site OCR · export into archive",
