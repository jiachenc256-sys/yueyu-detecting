...
const zhHans: Dict = {
  ...
  "tanci.note":
    "本页只做图片识别（无麦克风）。需本机或已部署的 Talcne 后端（默认 http://127.0.0.1:8000）。语音请用「听说翻译」。",
...
const zhHant: Dict = {
  ...
  "tanci.note":
    "本頁只做圖片識別（無麥克風）。需本機或已部署的 Talcne 後端（預設 http://127.0.0.1:8000）。語音請用「聽說翻譯」。",
...
const en: Dict = {
  ...
  "tanci.lead":
    "Upload tanci woodblock images, run OCR through the sister Talcne backend, proofread, then export JSON.",
  "tanci.note":
    "Image-only on this page (no microphone). Needs a local or deployed Talcne backend (default http://127.0.0.1:8000). For speech, use Speak.",
