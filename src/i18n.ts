...
const zhHans: Dict = {
  ...
  "home.support": "先看三步用法，再进入听说翻译或对话档案。",
  "home.how1Title": "选一条路",
  "home.how1Body": "听说翻译：说话或上传；档案：听精选戏曲并读剧情。",
  ...
  "archive.filterNote":
    "越剧为当前精选；弹词与广播为扩展层——弹词先链到姊妹项目 Talcne（刻本 OCR），再逐步并入本站时间轴档案。",
  "archive.tanciTitle": "弹词 · 文字层（Talcne）",
  "archive.tanciMeta": "姊妹项目 · 刻本 OCR → 可校对文字",
...
const zhHant: Dict = {
  ...
  "home.support": "先看三步用法，再進入聽說翻譯或對話檔案。",
  "home.how1Title": "選一條路",
  "home.how1Body": "聽說翻譯：說話或上傳；檔案：聽精選戲曲並讀劇情。",
  ...
  "archive.filterNote":
    "越劇為當前精選；彈詞與廣播為擴展層——彈詞先鏈到姊妹專案 Talcne（刻本 OCR），再逐步併入本站時間軸檔案。",
  "archive.tanciTitle": "彈詞 · 文字層（Talcne）",
  "archive.tanciMeta": "姊妹專案 · 刻本 OCR → 可校對文字",
...
const en: Dict = {
  ...
  "home.support": "Start with three steps, then open Speak or the Archive.",
  "home.how1Title": "Choose a path",
  "home.how1Body": "Speak: talk or upload. Archive: listen to curated opera clips with plot context.",
  ...
  "archive.filterNote":
    "Yue opera is the live starter set; tanci and radio are expansion layers — tanci links first to sister project Talcne (woodblock OCR), then folds into this timed archive.",
  "archive.tanciTitle": "Tanci · text layer (Talcne)",
  "archive.tanciMeta": "Sister project · woodblock OCR → editable text",
