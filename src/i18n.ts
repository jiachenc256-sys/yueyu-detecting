...
const zhHans: Dict = {
  ...
  "story.title": "故事 · 我们如何做成",
  "story.lead": "从收集录音到真人试听——把越语对话变成可听、可读、可检验的档案。",
  "story.s1Title": "收集与整理",
  "story.s1Body": "从本地戏曲录音与广播选段出发，建立清单与精选片段，而不是把整包音频丢上公网。",
  "story.s2Title": "转写与翻译",
  "story.s2Body": "为选段加上时间轴、简体 / 繁體 / English，并写清剧情简介，让不懂戏的人也能跟得上。",
  "story.s3Title": "真人试听检验",
  "story.s3Body": "请熟悉方言或戏曲的长辈与本地说话人试听、试说，对照识别结果是否“说得通、听得懂”。",
  "story.s4Title": "用档案反哺识别",
  "story.s4Body": "把校对过的语料当作训练与评测依据，让听说翻译从“普通话基线”慢慢靠近越语舞台方言。",
  "story.note": "当前识别仍是基线演示。故事的重点是方法：收集 → 标注 → 真人检验 → 再改进，而不是假装已经完美。",
...
const zhHant: Dict = {
  ...
  "story.title": "故事 · 我們如何做成",
  "story.lead": "從收集錄音到真人試聽——把越語對話變成可聽、可讀、可檢驗的檔案。",
  "story.s1Title": "收集與整理",
  "story.s1Body": "從本地戲曲錄音與廣播選段出發，建立清單與精選片段，而不是把整包音訊丟上公網。",
  "story.s2Title": "轉寫與翻譯",
  "story.s2Body": "為選段加上時間軸、簡體 / 繁體 / English，並寫清劇情簡介，讓不懂戲的人也能跟得上。",
  "story.s3Title": "真人試聽檢驗",
  "story.s3Body": "請熟悉方言或戲曲的長輩與本地說話人試聽、試說，對照識別結果是否「說得通、聽得懂」。",
  "story.s4Title": "用檔案反哺識別",
  "story.s4Body": "把校對過的語料當作訓練與評測依據，讓聽說翻譯從「普通話基線」慢慢靠近越語舞臺方言。",
  "story.note": "當前識別仍是基線演示。故事的重點是方法：收集 → 標註 → 真人檢驗 → 再改進，而不是假裝已經完美。",
...
const en: Dict = {
  ...
  "story.title": "Story · How we build it",
  "story.lead": "From collecting recordings to live listening tests — turning Yueyu dialogue into something you can hear, read, and check.",
  "story.s1Title": "Collect & organize",
  "story.s1Body": "Start from local opera recordings and radio selections. Inventory and curate clips — do not dump full packs onto the public web.",
  "story.s2Title": "Transcribe & translate",
  "story.s2Body": "Add timelines plus Simplified / Traditional / English, with short plot intros so newcomers can follow.",
  ...
  "story.s4Body": "Use corrected corpus for training and evaluation, moving Speak from a Mandarin baseline toward Yueyu stage dialect.",
  "story.note": "Recognition is still a baseline demo. The story is the method: collect → annotate → human-check → improve — not a claim of perfection.",
