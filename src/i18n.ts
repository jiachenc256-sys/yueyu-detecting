...
const zhHans: Dict = {
  ...
  "archive.filterNote":
    "越剧为当前精选；弹词可在导航「弹词」页上传图片做 OCR，也可链到姊妹项目 Talcne；广播为下一步扩展。",
...
const zhHant: Dict = {
  ...
  "archive.filterNote":
    "越劇為當前精選；彈詞可在導航「彈詞」頁上傳圖片做 OCR，也可鏈到姊妹專案 Talcne；廣播為下一步擴展。",
...
const en: Dict = {
  ...
  "archive.filterNote":
    "Yue opera is the live starter set; tanci OCR lives in the Tanci nav panel (Talcne backend). Radio is next.",
