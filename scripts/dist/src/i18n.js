...
const zhHans = {
    ...
    "archive.filterNote": "越剧为当前精选；弹词与广播为扩展层——弹词先链到姊妹项目 Talcne（刻本 OCR），再逐步并入本站时间轴档案。",
...
const zhHant = {
    ...
    "archive.filterNote": "越劇為當前精選；彈詞與廣播為擴展層——彈詞先鏈到姊妹專案 Talcne（刻本 OCR），再逐步併入本站時間軸檔案。",
...
const en = {
    ...
    "archive.filterNote": "Yue opera is the live starter set; tanci and radio are expansion layers — tanci links first to sister project Talcne (woodblock OCR), then folds into this timed archive.",
