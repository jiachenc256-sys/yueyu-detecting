...
const zhHans = {
    ...
    "archive.filterNote": "越剧与弹词文字层均为精选；弹词也可在导航「弹词」页上传图片做 OCR 后导入档案；广播为下一步扩展。",
...
const zhHant = {
    ...
    "archive.filterNote": "越劇與彈詞文字層均為精選；彈詞也可在導航「彈詞」頁上傳圖片做 OCR 後導入檔案；廣播為下一步擴展。",
...
const en = {
    ...
    "archive.filterNote": "Yue opera and a tanci text-layer starter are live; OCR more pages in the Tanci panel, then import. Radio is next.",
