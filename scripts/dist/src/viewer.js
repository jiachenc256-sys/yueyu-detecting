...
let textOnly = false;
function isTextOnlyPiece(piece) {
...
function renderTranscript() {
    ...
    for (const cue of transcript.cues) {
        ...
        const jumpToCue = () => {
            ...
            if (nowTimeEl && textOnly)
                nowTimeEl.textContent = formatTime(cue.start);
            if (nowLineEl && textOnly)
                nowLineEl.textContent = primaryDisplayText(cue, displayMode);
        };
